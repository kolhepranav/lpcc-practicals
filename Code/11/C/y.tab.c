...
static const char *const yytname[] =
{
  ...
  "STRING", "EQ", "SQRT", "STRLEN", "'('", "')'", "$accept", "input",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* input: ID EQ func_call  */
#line 31 "taskC.y"
                      {
        if (strcmp((yyvsp[-2].sval), "u") == 0)
            printf("u = %lf\n", (yyvsp[0].dval));
        else
...
#line 1147 "y.tab.c"
  ...
  case 3: /* func_call: SQRT '(' expr ')'  */
#line 41 "taskC.y"
                              { (yyval.dval) = sqrt((yyvsp[-1].dval)); }
#line 1153 "y.tab.c"
    break;

  case 4: /* func_call: STRLEN '(' STRING ')'  */
#line 42 "taskC.y"
                              { (yyval.dval) = (double)strlen((yyvsp[-1].sval)); free((yyvsp[-1].sval)); }
#line 1159 "y.tab.c"
    break;
